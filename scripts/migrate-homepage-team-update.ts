...
const TEAM: TeamMemberSeed[] = [
  {
    ...
    role: "Радиолог",
    description: "Специјалиста радиологије Националног института за срце и крвне судове „Дедиње”.",
  },
  {
    key: "team-member-2",
    image:
    ...
    description:
      "Специјалиста анестезије са реаниматологијом Националног института за срце и крвне судове „Дедиње”.",
  },
  {
    key: "team-member-3",
    ...
    description: "Специјалиста интервентне кардиологије Националног института за срце и крвне судове „Дедиње”.",
  },
  {
    key: "team-member-4",
    image: "/images/Dr. sci. med. Bogdan Okiljević.jpg",
    name: "Асс. др Богдан Окиљевић",
    role: "Кардиохирург",
    description:
      "Кардиохирург Националног института за срце и крвне судове „Дедиње”, специјализован за минимално инвазивну и ендоскопску кардиохирургију.",
  },
];
