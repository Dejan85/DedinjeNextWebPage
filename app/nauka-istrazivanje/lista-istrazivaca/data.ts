...
const intro: IntroSectionBlock = {
  ...
  paragraphs: [
    'Научноистраживачки рад Института за кардиоваскуларне болести „Дедиње" остварује тим истраживача организованих по категоријама — од виших научних сарадника до истраживача приправника.',
  ],
  stats: [
