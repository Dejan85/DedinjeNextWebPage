...
const intro: IntroSectionBlock = {
  _type: "introSection",
  icon: "fas fa-flask",
  heading: "Истраживачки тим Института",
  paragraphs: [
    'Научноистраживачки рад Националног института за срце и крвне судове „Дедиње” остварује тим истраживача организованих по категоријама — од виших научних сарадника до истраживача приправника.',
  ],
  stats: [
    { value: "62", label: "истраживача" },
    { value: "4", label: "категорије" },
  ],
};

const accordion: AccordionBlockData = {
  _type: "accordionBlock",
  title: 'Истраживачи Националног института за срце и крвне судове „Дедиње”',
  defaultOpenId: "visi-naucni-saradnici",
  items: [
    {
      itemId: "visi-naucni-saradnici",
    ...
    {
      itemId: "istrazivaci-pripravnici",
...
export const DATA: PatientPage = {
  ...
  subtitle: "Истраживачи Националног института за срце и крвне судове „Дедиње”",
