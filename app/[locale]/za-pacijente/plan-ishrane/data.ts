...
const kalorijskiPlanovi: CardGridBlockData = {
  ...
  intro:
    'Национални институт за срце и крвне судове „Дедиње” пружа детаљан план препоручене исхране за превенцију и лечење метаболичких и кардиоваскуларних обољења, са различитим калоријским вредностима.',
  cards: [
    {
