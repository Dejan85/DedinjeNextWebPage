...
const accordion: AccordionBlockData = {
  ...
  subtitle:
    "Изаберите околност и сазнајте више о поступку пријема, потребној документацији и времену пријема",
  ...
  items: [
    {
      ...
      sections: [
        ...
        { title: "Време пријема", kind: "text", text: ["07:30 – 11:00"] },
      ...
      sections: [
        {
          ...
          text: [
            ...
            "Из овог разлога, најљубазније молимо болеснике да на пријему поседују уредну и потпуну медицинску документацију уз обавезан оверен упут за болничко лечење за Национални институт за срце и крвне судове „Дедиње”.",
        ...
        { title: "Време пријема", kind: "text", text: ["08:00-11:00"] },
        { title: "Контакт", kind: "text", text: [KONTAKT] },
      ],
    },
    {
      itemId: "vaskularna-hirurgija",
      ...
      sections: [
        ...
        { title: "Време пријема", kind: "text", text: ["07:00 – 08:00"] },
        { title: "Контакт", kind: "text", text: [KONTAKT] },
      ],
    },
  ],
