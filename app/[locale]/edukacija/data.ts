...
const intro: IntroSectionBlock = {
  ...
  heading: "О едукацији",
  paragraphs: [
    'Национални институт за срце и крвне судове „Дедиње” је центар за едукацију и усавршавање стручњака у области кардиоваскуларне медицине. Кроз едукативне програме, радионице и конгресе пружамо могућност континуираног образовања лекара и медицинског особља.',
