...
const intro: IntroSectionBlock = {
  ...
  paragraphs: [
    'Национални институт за срце и крвне судове „Дедиње” нуди различите едукативне програме усмерене на обуку и усавршавање стручњака у области кардиоваскуларне медицине. Програми обухватају континуирану медицинску едукацију (КМЕ), специјализоване школе и практичне обуке.',
