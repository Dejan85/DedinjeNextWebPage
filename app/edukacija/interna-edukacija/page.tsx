    ...
    <>
      ...
      <Section padding="medium" background="white">
        <Container>
          ...
          <div className={styles.planBlock}>
            <h3 className={styles.planTitle}>
              <i className="fas fa-calendar-days" aria-hidden /> Теме и предавачи (2024–2026)
            </h3>
            <p>
              ...
              лечења за медицинске сестре/техничаре. Предавања са овог семинара су
              снимљена и постављањем на ову платформу доступна свим медицинским
              сестрама и техничарима Института за кардиоваскуларне болести
              „Дедиње“. Циљ предавања је да се обнове и стекну нова знања и вештине
              које ће одмах бити преточене у свакодневни клинички рад.
            </p>
            <p>Предавања су из седам области:</p>
            <ul className={styles.planList}>
              {KME_OBLASTI.map((oblast) => (
                <li key={oblast}>
                  <i className="fas fa-check" aria-hidden />
                  {oblast}
                </li>
