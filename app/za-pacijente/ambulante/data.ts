...
const intro: IntroSectionBlock = {
  ...
  paragraphs: [
    "Институт за кардиоваскуларне болести Дедиње пружа широк спектар амбулантних услуга — од кардиохируршке и кардиолошке амбуланте, преко аритмолошке и васкуларне, до лабораторије и преоперативне припреме. Изаберите амбуланту и сазнајте радно време, потребну документацију и контакт информације.",
  ],
  stats: [
